...
namespace DAL
{
    ...
    public class DatabaseInitializer : IDatabaseInitializer
    {
        ...
        private readonly IApplicationUserService _accountManager;
        private readonly ILogger _logger;

        public DatabaseInitializer(QuestOrAssessIdentityDbContext context, IApplicationUserService accountManager, ILogger<DatabaseInitializer> logger)
        {
